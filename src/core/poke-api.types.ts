 ...
 */
export type GetParams<T extends TypeMapKeys> =
  T extends UnnamedPaginationResource ? number : number | string;

/**
 * PokeApiProps interface `.getAll()` method parameter type definition.
 * @template T PokéApi resource endpoint
 */
export type GetAllParams<T> = T extends SubCollectionResource
  ? number | string
 ...
 * @template T PokéApi resource endpoint
 */
export type GetByNameReturn<T extends TypeMapKeys> = Promise<
 ...
 * @template T PokéApi resource endpoint
 */
export type GetAllReturn<T> = Promise<
  T extends SubCollectionResource
    ? TypeMap[T]
 ...
 * @template T PokéApi resource endpoint
 */
export type CountReturn<T> = Promise<
  T extends SubCollectionResource ? never : number
>;
 ...
 * @template T PokéApi resource endpoint
 */
export type PaginateReturn<T extends TypeMapKeys> = Promise<
  T extends SubCollectionResource ? never : Model.PaginatedResult
>;
