 ...
 */
export declare const getEruptionBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getWaterSpoutBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getCrushGripBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getWringOutBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getHardPressBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getReversalBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getFlailBasePower: (currentHp: number, maxHp: number) => number;
/** Returns the Base Power (BP) for
 ...
 * @returns {number} The move BP.
 */
export declare const getBrineBasePower: (currentHp: number, maxHp: number) => number;
