 ...
 * @returns {number} The move BP.
 */
export declare const getHeavySlamBasePower: (params: GetMoveBasePowerByRelativeWeightParams) => number;
/** Returns the move Base Power (BP) according the weight ratio between two Pokémon for move
 ...
 * @returns {number} The move BP.
 */
export declare const getHeatCrashBasePower: (params: GetMoveBasePowerByRelativeWeightParams) => number;
 ...
 * @returns {number} The move BP.
 */
export declare const getLowKickBasePower: (weight: number) => number;
export {};
